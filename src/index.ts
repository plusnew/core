...
class Plusnew {
   ...
   */
  public createElement<element extends keyof plusnew.JSX.IntrinsicElements>(
    type: element,
   ...
   */
  public render<HostElement, HostTextElement>(
    element: PlusnewAbstractElement,
    options: renderOptions<HostElement, HostTextElement>
  ) {
    ...
    const wrapper = new RootInstance(
      true,
      undefined,
      predecessor,
      internalOptions
