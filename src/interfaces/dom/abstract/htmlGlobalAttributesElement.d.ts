...
type htmlGlobalAttributesElement<currentElement> = {
  ...
  ontouchstart?: (event: TouchEvent & { currentTarget: currentElement }) => void;
  ontouchmove?: (event: TouchEvent & { currentTarget: currentElement }) => void;
  ontouchend?: (event: TouchEvent & { currentTarget: currentElement }) => void;
  ontouchcancel?: (event: TouchEvent & { currentTarget: currentElement }) => void;
