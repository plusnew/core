...
export class ElementTypeChecker {
  ...
  ): abstractElement is string | number {
    return (
      typeof abstractElement === "string" || typeof abstractElement === "number"
    );
  }

  public isArrayElement(
    abstractElement: ApplicationElement
  ): abstractElement is PlusnewAbstractElement[] {
    return Array.isArray(abstractElement);
  }

  public isFragmentElement(
    abstractElement: ApplicationElement
  ): abstractElement is PlusnewAbstractElement {
    if (
  ...
  public isDomElement(
    ...
    if (
      ...
      return (
        typeof (abstractElement as PlusnewAbstractElement).type === "string"
      );
    }
  ...
  public isPlaceholderElement(
    abstractElement: ApplicationElement
  ): abstractElement is boolean {
    return (
  ...
  public isComponentElement(
    ...
    if (
      ...
      return (
        typeof (abstractElement as PlusnewAbstractElement).type === "function"
      );
    }
